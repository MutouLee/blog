...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection stick
     ...
     * @method Grid\Column|Collection stick(string $label = null)
     ...
     * @property Show\Field|Collection stick
     ...
     * @method Show\Field|Collection stick(string $label = null)
